# Developing a Parental Filter Using NetBlocks and Twitter Feed

Welcome back to *Programming for a Network World*. In today's lesson, we will explore how to create a parental filter using NetBlocks by obtaining a feed from Twitter and filtering out any bad words in the tweets. You will have control over the sensitivity level, which determines how carefully the text should be filtered.
...
- Accessing and filtering Twitter feeds using NetBlocks.
